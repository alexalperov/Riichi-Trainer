export const en = {
    translations: {
        ...
        trainer: {
            ...
            soundOff: "Sound off",
            counting: {
                instructions: "Click the tile you want to discard, then enter how many tiles would improve your hand after that discard and submit.",
                noTileSelected: "Select a tile",
                selectedTile: "Discarding {{tile}}:",
                guessPlaceholder: "Tile count",
                submitButtonLabel: "Discard"
            },
            error: {
        ...
        history: {
            ...
            concise: {
                ...
                countCorrect: " Counted {{count}} - right!",
                countIncorrect: " Counted {{guess}}, actual {{count}}.",
                countMissing: " No count entered; it was {{count}}.",
                optimal: " Best:",
                optimalSpoiler: " {{tile}}",
            ...
            verbose: {
                ...
                countCorrect: " You correctly counted {{count}} tiles of acceptance!",
                countIncorrect: " You counted {{guess}} tiles of acceptance, but the actual count was {{count}}.",
                countMissing: " You didn't enter an acceptance count. It was {{count}}.",
        ...
        settings: {
            ...
            ukeireCounting: "Ukeire counting mode (enter how many tiles improve your hand before each discard)",
        ...
        stats: {
            ...
            countAccuracy: "Ukeire Count Accuracy: {{percent}}% ({{achieved}}/{{total}})",
            reset: "Reset Stats",
            ...
            mistakes: {
                ...
                presentTitle: "Wait shapes present in mistakes",
                presentHint: "Each suboptimal discard is counted once for every listed shape present anywhere in the hand. One mistake can appear in several rows; mirrored forms share a row.",
                presentEmpty: "No matching wait-shape mistakes recorded yet.",
                presentWaits: "wins {{waits}}",
                noMatchingMistakes: "no matching mistakes yet",
                presentNames: {
                    tanki: "Tanki",
                    aryanmen: "Aryanmen",
                    ryantan: "Ryantan",
                    ...
                    entotsu: "Entotsu",
                    sanmenNobetan: "Sanmen nobetan",
                    tatsumaki: "Tatsumaki",
                    happoubijin: "Happoubijin"
                },
                presentPatterns: {
                    tanki: "X",
                    aryanmen: "XX (X+1) (X+2) / (X−2) (X−1) XX",
                    ryantan: "XXX (X+1) / (X−1) XXX",
                    kantan: "XXX (X+2) / (X−2) XXX",
                    pentan: "1112 / 8999",
                    nobetan: "X through (X+3)",
                    sanmenchan: "X through (X+4)",
                    entotsu: "XXX (X+1) (X+2) + YY / mirrored",
                    sanmenNobetan: "X through (X+6)",
                    tatsumaki: "XXX (X+1) (X+2)(X+2)(X+2)",
                    happoubijin: "XXX (X+1) through (X+4) (X+5)(X+5)(X+5)"
                },
                presentWinning: {
                    tanki: "X",
                    aryanmen: "X, X+3 / X−3, X",
                    ryantan: "X−1, X+1, X+2 / X−2, X−1, X+1",
                    kantan: "X+1, X+2 / X−2, X−1",
                    pentan: "2, 3 / 7, 8",
                    nobetan: "X, X+3",
                    sanmenchan: "X−1, X+2, X+5",
                    entotsu: "X, X+3, Y / X−3, X, Y",
                    sanmenNobetan: "X, X+3, X+6",
                    tatsumaki: "X−1 through X+3",
                    happoubijin: "X−1 through X+6"
                },
                broke: {
        ...
        hardMode: {
            badge: "Expert drill",
            title: "Complex Shape Hunt",
            description: "Efficient play runs in the background until a meaningful complex-shape decision appears. Take over for the difficult discard, then hunt again.",
            statsLabel: "Hard mode statistics",
            streak: "Streak",
            accuracy: "Accuracy",
            solved: "Solved",
            searching: "Playing hands in the background…",
            searchProgress: "{{count}} hand searched",
            searchProgress_plural: "{{count}} hands searched",
            turn: "Turn {{count}}",
            autoplayed: "{{count}} optimal discard autoplayed",
            autoplayed_plural: "{{count}} optimal discards autoplayed",
            shanten: "{{count}} shanten",
            prompt: "The shape is here. What do you discard?",
            promptHint: "Preserve the best shanten and maximize the live improving tiles.",
            review: "Decision review",
            reviewHint: "The detected shape and its full winning pattern are now revealed.",
            correct: "Correct — you preserved the strongest shape.",
            incorrect: "Not quite — this cut gives up efficiency.",
            chosenResult: "Your {{tile}} leaves {{count}} improving tile.",
            chosenResult_plural: "Your {{tile}} leaves {{count}} improving tiles.",
            ...
            shapeHidden: "Name the structure yourself before committing to a tile.",
            shapeRevealed: "This pattern is preserved by every optimal cut and broken by at least one plausible alternative.",
            winningTiles: "Winning structure: {{waits}}",
            skip: "Skip this position"
        },
        allLast: {
            placements: {
                first: "first",
