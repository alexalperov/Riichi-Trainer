    ...
    translations: {
        ...
        trainer: {
            ...
            feedback: {
                ...
                acceptance: "{{count}} tile can improve your hand.",
                acceptance_plural: "{{count}} tiles can improve your hand.",
                suboptimal: "Good — {{count}} tile.",
                suboptimal_plural: "Good — {{count}} tiles.",
                bestWas: "The best discard accepted {{count}}.",
                bestWasSpoiler: "Best: {{tile}}, accepting {{count}}.",
                shantenUp: "That moved you further from ready.",
                notenTitle: "Ready shape, but not tenpai.",
                noten: "Every tile that completes your hand is already in it — reshape your wait.",
                furiten: "Watch out for furiten!",
                streak: "{{count}} optimal discards in a row",
                efficiencyLabel: "Efficiency",
                complete: "Tenpai!",
                completeSub: "Your hand is ready — efficiency {{percent}}%."
            },
            error: {
