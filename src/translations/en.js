export const en = {
    translations: {
        ...
        hardMode: {
            ...
            description: "Efficient play runs in the background until the optimal discard will form a complex shape. Take over one step before the shape appears, then hunt again.",
            ...
            prompt: "One discard creates a complex shape. Which one?",
            promptHint: "Read what the 13-tile hand becomes after each possible cut, then maximize the live improving tiles.",
            review: "Decision review",
            reviewHint: "The detected shape and its full winning pattern are now revealed.",
            correct: "Correct — your discard forms the complex shape.",
            ...
            shapeRevealed: "This is the structure created in the 13-tile hand by the optimal discard.",
